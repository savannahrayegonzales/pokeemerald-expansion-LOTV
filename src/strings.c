...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("LILY");
const u8 gText_ExpandedPlaceholder_May[] = _("SAVANNAH");
...
const u8 gText_Boy[] = _("JEWISH");
const u8 gText_Girl[] = _("FRIEND");
